$(document).ready(function()
{
	...
	$("#right, #picmore").click(function()
	{
		...
		else if (move == 1)
		{
			...
			$("#descmore").empty();
			$("#descmore").append("<h3>OFFRE DE FORMATION : Programmeur Ruby, Python et JavaScript.</h3><br><p>Au delà des touches d’un clavier ou des fonctionnalités d’un objet connecté se trouvent en réalité une multitude de lois qui régissent chacune des commandes qui nous sont offertes. Apprendre la programmation, c’est voir au delà des fonctionnalités que l’on nous offre au quotidien et pour en développer de nouvelles !</p><br><ul><li>Problèmes à résoudre via Ruby et Python (24 heures)</li><li>Développer soi-même sur JavaScript (16 heures)</li><li>Reproduire un programme déjà existant (16 heures)</li><li>Créer son propre programme (32 heures)</li>");
			$("#gens").empty();
	...
	$("#switch").click(function()
	{
		...
		if (coms == 1)
		{
			...
			$("#footcoms").append("<div id=coms><blockquote><p>« Au départ, j’ai appris la programmation et le développement par passion. Pendant mes études d’ingénieur, j’ai toujours aimé hacker les choses qui m’environnaient. Par hacking, j’entends déconstruire : comprendre comment les mécanismes fonctionnent et les réutiliser pour leur trouver d’autres utilités.»</p></blockquote></div>");
		}
		else if (coms == 2)
		{
			$("#footcoms").empty();
